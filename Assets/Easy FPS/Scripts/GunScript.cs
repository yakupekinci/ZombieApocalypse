...
public class GunScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            print("Weapon");
            bulletsIHave = bulletCounter.bulletCountAk;
            bulletsInTheGun = bulletCounter.InBulletCountAk;
        }
        else if (this.gameObject.tag == "Weapon2")
        {
            print("Weapon2");
            bulletsIHave = bulletCounter.bulletCountSnip;
            bulletsInTheGun = bulletCounter.InBulletCountSnip;
	...
	*/
    ...
    void OnGUI()
    {
        ...
        if (mls && HUD_bullets)
            HUD_bullets.text = bulletsInTheGun.ToString() + " - " + bulletsIHave.ToString();
